...
(async ({ current_script, facet, facet_export, facet_load_error }) => { try {  // facet begin
    ...
    class EditChange extends Change {
    ...
    class MoveIEChange extends Change {
    ...
    class AddNewIEChange extends Change {
    ...
    class DeleteIEChange extends Change {
    ...
    class StateChange extends Change {
        constructor(notebook, old_state, new_state) {  // e.g., state: { auto_hide_inputs }
            super(notebook);
    ...
    class OutputIEChange extends Change {
    ...
    function add_edit_change(notebook, ie_id, changes) {
        Change.add_change(new EditChange(notebook, ie_id, changes));
    }

    function perform_move_ie_change(notebook, old_position, new_position) {
        Change.add_change(new MoveIEChange(notebook, old_position, new_position), true);
    }

    function perform_move_up_ie_change(notebook, ie_id) {  // returns true iff move was possible
    ...
    function perform_move_down_ie_change(notebook, ie_id) {  // returns true iff move was possible
        const order = notebook.nb_state.order;
        const ie_position = order.indexOf(ie_id);
